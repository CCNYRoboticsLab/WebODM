...
class Plugin(PluginBase):
    ...
    def main_menu(self):
        return [
            Menu(_("Crack Annotations"), self.public_url(""), "fa fa-chart-pie fa-fw")
        ]
    ...
    def app_mount_points(self):
        ...
        def diagnostic(request):
            ...
            # Get crack data
            crack_data = (
                PatchCrack.objects.using("mariadb")
                .filter(length_area__isnull=False)
                .exclude(length_area=0)
            )
            template_args = {
                "title": "Diagnostic1",
            ...
            return render(
                request, self.template_path("diagnostic1.html"), template_args
            )
